...
var AppComponent = /** @class */ (function () {
    function AppComponent(zone) {
        ...
        // Connection
//        this.ip = window.location.origin; // window.location.hostname or ip
        this.ip = "192.168.43.1"; // window.location.hostname or ip
//        console.log("IP is: " + this.ip);
    ...
    AppComponent.prototype.addMessage = function (msg) {
        ...
        var message = new _message_model__WEBPACK_IMPORTED_MODULE_1__["Message"](obj.username, new Date(+obj.timestamp), obj.data, obj.vstate, obj.userId, obj.messageId, obj.latlng);
    ...
    AppComponent.prototype.send = function () {
        ...
        var message = new _message_model__WEBPACK_IMPORTED_MODULE_1__["Message"](this.user.name, new Date(), this.msg, this.user.vstate, this.user.id, Date.now(), "");
...
module.exports = "<br><br>\n<div class=\"Aligner\">\n  <div class=\"Aligner-item\">\n    <mat-form-field>\n      <input matInput placeholder=\"Ad Soyad\" [(ngModel)]=\"username\" type=\"text\" required>\n      <mat-error *ngIf=\"!username\">Lütfen isminizi giriniz</mat-error>\n    </mat-form-field>\n  <br>\n  <br>\n  <label id=\"label-state\">Lütfen durumunuzu seçiniz</label>\n <br> \n <mat-radio-group\n aria-labelledby=\"abel-state\"\n class=\"state-radio-group\"\n [(ngModel)]=\"vstate\">\n <mat-radio-button class=\"state-radio-button\" value=\"1\">İyiyim, enkaz altında değilim</mat-radio-button>\n <br>\n <mat-radio-button class=\"state-radio-button\" value=\"2\">İyiyim, enkaz altındayım</mat-radio-button>\n <br>\n <mat-radio-button class=\"state-radio-button\" value=\"3\">Kötüyüm, enkaz altında değilim</mat-radio-button>\n <br>\n <mat-radio-button class=\"state-radio-button\" value=\"4\">Kötüyüm, enkaz altındayım</mat-radio-button>\n <br>\n </mat-radio-group>\n <br>\n <br>\n <button mat-raised-button color=\"primary\" (click)=\"login()\" [disabled]=\"!username || !vstate\">Giriş</button>\n  </div>\n</div>"
...
var Message = /** @class */ (function () {
    function Message(username, timestamp, data, vstate, userId, messageId, latlng) {
